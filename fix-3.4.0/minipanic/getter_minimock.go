...
func (m *GetterMock) MinimockGetInspect() {
	...
	if m.GetMock.defaultExpectation != nil && afterGetCounter < 1 {
		m.t.Errorf("Expected call to GetterMock.Get at\n%s", m.GetMock.defaultExpectation.returnOrigin)
	}
	...
	if !m.GetMock.invocationsDone() && afterGetCounter > 0 {
		m.t.Errorf("Expected %d calls to GetterMock.Get at\n%s but found %d calls",
...
func (mmGet2 *mGetterMockGet2) Return() *GetterMock {
	...
	mmGet2.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet2.mock
}
...
func (mmGet2 *mGetterMockGet2) Set(f func()) *GetterMock {
	...
	mmGet2.mock.funcGet2Origin = minimock.CallerInfo(1)
	return mmGet2.mock
}
...
func (mmGet2 *mGetterMockGet2) Times(n uint64) *mGetterMockGet2 {
	...
	mmGet2.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGet2
}
...
func (m *GetterMock) MinimockGet2Inspect() {
	...
	if m.Get2Mock.defaultExpectation != nil && afterGet2Counter < 1 {
		m.t.Errorf("Expected call to GetterMock.Get2 at\n%s", m.Get2Mock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.Get2Mock.invocationsDone() && afterGet2Counter > 0 {
		m.t.Errorf("Expected %d calls to GetterMock.Get2 at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.Get2Mock.expectedInvocations), m.Get2Mock.expectedInvocationsOrigin, afterGet2Counter)
	}
}
